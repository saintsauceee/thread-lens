      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label style={{ display: 'block', marginBottom: '22px' }}>
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', display: 'block', marginBottom: '6px' }}>Confirm password</span>
            <input
              type="password"
              value={confirm}
        ...
        <p style={{ marginTop: '18px', fontSize: '13px', color: 'rgba(255,255,255,0.3)' }}>
          Have an account?{' '}
          <a href="/auth/login" style={{ color: 'rgba(129,140,248,0.8)', textDecoration: 'none' }}>Sign in</a>
        </p>
      </div>
    </div>
  );
